                                                                        ...
                                                                        @foreach($users as $key => $user)
                                                                            @if($key < 3)
                                                                                <a href="#" class="avatar rounded-circle avatar-sm">
                                                                                    <img alt="image" data-toggle="tooltip" data-original-title="{{$user->name}}" @if($user->avatar) src="{{$logo.$user->avatar}}" @else avatar="{{ $user->name }}"@endif>
                                                                                </a>
                                                                            @endif
                                                                        @endforeach
                                                                        @if(count($users) > 3)
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var html = "<div class='card mb-1 shadow-none border'>" +
                            ...
                            "                                </div>" +
                            "                                <div class='col-auto'>" +
                            "                                    <a download href='{{$logo_tasks}}/" + data.file + "' class='btn btn-link text-muted'>" +
