...
@section('action-button')
    <div class="btn-group mx-1" id="change_view" role="group">
        ...
        <a href="{{ route($is_client . 'projects.gantt.custom', [$currentWorkspace->slug, $project->id, 'Day']) }}"
            class="btn btn-sm px-3 btn-primary @if ($duration == 'Day') active @endif"
            data-value="Day">{{ __('Day') }}</a>
        <a href="{{ route($is_client . 'projects.gantt.custom', [$currentWorkspace->slug, $project->id, 'Week']) }}"
            class="btn btn-sm px-3 btn-primary @if ($duration == 'Week') active @endif"
            data-value="Week">{{ __('Week') }}</a>
        <a href="{{ route($is_client . 'projects.gantt.custom', [$currentWorkspace->slug, $project->id, 'Month']) }}"
            class="btn btn-sm px-3 btn-primary @if ($duration == 'Month') active @endif"
