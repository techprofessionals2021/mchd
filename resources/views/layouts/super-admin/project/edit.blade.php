...
<form class="" method="post" action="{{ route('superadmin.projects.update', [$currentWorkspace->slug, $project->id]) }}" onkeydown="return event.key != 'Enter';">
    @csrf
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                "form-label">{{ __('Description') }}</label>
