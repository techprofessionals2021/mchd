                        ...
                        <table class="table table-bordered data-table" style="width: 100%">
                            ...
                            <tbody>
                                ...
                                <td> 
                                    ...
                                    <a href="{{route('superadmin.workspace_tasks', ['project_id' => $item->id])}}" class="btn btn-light btn-sm" >
                                        <i class="fas fa-eye"></i> 
                                    </a>

                                    <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="lg" data-title="{{ __('Edit Project') }}" data-url="{{ route('superadmin.projects.edit', [$item->workspaceData->slug, $item->id]) }}" data-toggle="tooltip" title="{{ __('Edit Project') }}"><i class="fas fa-edit"></i></a>
